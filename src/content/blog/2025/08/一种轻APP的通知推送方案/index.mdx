...
tags:
  - 经验分享
language: '中文'
heroImage: { src: './thumbnail.jpg', color: '#96785B' }
comment: true
---
...
![访问8800端口](https://cdn.blog.saneko.me/Blog/blog_250821_141617.png)

4. 客户端配置

在苹果商店搜索「PushDeer·自架版」或扫描上方的二维码进行安装并启动

![登录apk](https://cdn.blog.saneko.me/Blog/blog_250821_143221.jpg)

API服务地址输入http://公网ip:8800, 并用苹果id进行登录

![注册](https://cdn.blog.saneko.me/Blog/blog_250821_143435.jpg)

登陆后，没有注册就先进行注册

![注册完成](https://cdn.blog.saneko.me/Blog/blog_250821_143528.jpg)
...
![消息推送](https://cdn.blog.saneko.me/Blog/blog_250821_143727.jpg)

<Aside>实测,APP退出或者在锁屏界面也可以接收到推送</Aside>
...
[下载文件](https://taonotespace.com/download/init.sh), 将文件拷贝到服务器的pushdeer目录下。
