...
tags:
  - 经验分享
language: '中文'
heroImage: { src: './thumbnail.jpg', color: '#8E9B7D' }
comment: true
---
...
![下载Ollama](https://cdn.blog.saneko.me/Blog/blog_250218_173055.png)

#### 下载模型

回到[ollama](https://ollama.com/)官网，在搜索栏中搜索`deepseek-r1`

![搜索deepseek](https://cdn.blog.saneko.me/Blog/blog_250218_174912.png)

选择对应参数模型，复制指令。

![下载模型](https://cdn.blog.saneko.me/Blog/blog_250218_182347.png)
...
![模型推理](https://cdn.blog.saneko.me/Blog/blog_250218_182853.png)
...
![下载Chatbox](https://cdn.blog.saneko.me/Blog/blog_250218_183550.png)

#### 模型设置

打开安装好后的**chatbox**，点击设置，将模型提供方选择为**OLLAMA API**，模型中会自动加载在ollama中下载部署好的模型。

![模型设置](https://cdn.blog.saneko.me/Blog/blog_250218_183753.png)

#### 使用

![模型对话](https://cdn.blog.saneko.me/Blog/blog_250218_185302.png)