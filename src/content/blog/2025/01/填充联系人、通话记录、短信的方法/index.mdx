...
tags:
  - Code
language: '中文'
heroImage: { src: './thumbnail.jpg', color: '#8E44AD' }
comment: true
---
...
<Tabs>
  <TabItem label="权限">
- 短信较为特殊，由于[Android4.4](https://developer.android.com/guide/topics/permissions/default-handlers?hl=zh-cn)之后，除了`默认短信应用`以外，其他应用将无法插入短信。因此需要将APK`伪装`成一个短信应用，并设置为默认的短信应用。
...
![创建所须的类](https://cdn.blog.saneko.me/Blog/blog_250116_232142.png)
